             ...
             if($_FILES['content_file']['name'] !='')
             {
               $config['upload_path'] = 'asset/course_content/'; 
                ...
                $file_name=$this->input->post('doc_name');
                       ...
                       if(!$result)
                       {
                         ...
                         $data['msg']="Successfully Added";
                         $this->session->set_flashdata('msg','Sorry content update failed.Try again later');
               ...
               redirect('admin/all_content');
                       ...
                       else
                       {
                         ...
                         $this->session->set_flashdata('msg','Content Update Successfully');
                 //$this->admin_template->load('master_view', 'contents' , 'admin/courses', $data);
                redirect('admin/all_content');
      ...
      if($_FILES['thumb_img']['name'] !='')
          ...
          else
          {
              ...
              $thumb_name=  $filename3;
                ...
                if(!$result)
                {
                  ...
                  $data['msg']="Successfully Added";
                  $this->session->set_flashdata('msg','Sorry content upload failed.Try again later');
        ...
        redirect('admin/all_content');
                ...
                else
                {
                  ...
                  $this->session->set_flashdata('msg','Content Add Successfully');
          //$this->admin_template->load('master_view', 'contents' , 'admin/courses', $data);
        redirect('admin/all_content');
