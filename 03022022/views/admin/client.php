    ...
    <div class="container-fluid">
        ...
        <a href="<?php echo base_url('admin/add_partner');?>" name="add_partner" id="add_partner"  class="custom-btn-main d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">  Add Ambassador</a>
        <a data-toggle="modal" data-target="#myModal"  name="invite_partner" id="invite_partner" class="custom-btn-main d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" > Invite Ambassador</a>
</div>
</div>
        <!-- DataTales Example -->
