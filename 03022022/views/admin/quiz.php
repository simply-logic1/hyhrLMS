    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <div class="row">
        <h1 class="col-lg-6 h3 mb-2 text-gray-800 main-head">Quiz</h1>
        <div class="col-lg-6 text-right align-items-center justify-content-end mb-4">
        
      
        <a href="<?php echo base_url('admin/add_quiz');?>"  name="add_quiz" id="add_quiz"  class="custom-btn-main nd-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"> Add Quiz</a>
                                            ...
                                            $this->load->helper('secure');
                                                ...
                                                foreach($test_list as $test)
                                               {
                                                   ...
                                                   echo "<td><input type='hidden' name='test_id' id='test_id' value='".$del_id."'></td>";
                                                    echo "<td> ".ucwords($test['course_title'])."</td>";
