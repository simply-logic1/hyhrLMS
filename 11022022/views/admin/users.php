    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <div class="row">
        <h1 class="col-lg-6 h3 mb-2 text-gray-800 main-head">Users</h1>
        <div class="col-lg-6 text-right align-items-center justify-content-end mb-4">
        
      
        <a href="<?php echo base_url('admin/add_user');?>" name="add_partner" id="add_partner"  class="custom-btn-main d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"> Add User</a>
        ...
        <div class="card shadow mb-4">
            ...
            <?php
                   ...
                   ?>
            <div class="alert alert-success" role="alert" id="success_message" style="display:none">User Deleted Successfully</div>
...
{   
  ...
  echo "<tr><td><input type='hidden' name='emp_id' id='emp_id' value='".$id."'></td><td>".ucwords($client['name'])."</td>";
