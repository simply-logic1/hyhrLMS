...
$route['education']='employee/Employee/content_list';
...
$route['content_details/(:any)']='employee/Course_empctrl/view_content';
$route['category']='employee/Employee/category';
$route['category/(:any)']='employee/Course_empctrl/view_category';
$route['library/take_test/(:any)']='employee/Testctrl/test';
$route['library/result/(:any)']='employee/Testctrl/show_result';
$route['cron']='admin/CronControl/reminder_mail';
$route['file_download/(:any)']='admin/Dashboard/file_download';
$route['resize_image']="admin/Dashboard/resize_image";
...
$route['document']='employee/Employee/document';

/* Admin -Side */
$route['admin/test_details/(:any)/(:any)']="admin/Dashboard/get_test_result";
$route['admin/survey']='admin/Dashboard/survey';
$route['admin/document']='admin/Dashboard/document';
$route['admin/add_survey']='admin/Dashboard/add_survey';
$route['admin/add_document']='admin/Dashboard/add_doc';
$route['admin/add_doc_data']='admin/Courses/add_doc_data';
$route['admin/del_video/(:any)']='admin/Courses/del_video_course';
$route['admin/test/details/(:any)']='admin/Client/view_test_data';
$route['admin/survey/details/(:any)']='admin/Client/view_survey_data';
...
$route['admin/view_post/(:any)']='admin/Dashboard/video_data';
