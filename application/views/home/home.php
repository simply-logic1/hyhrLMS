                                ...
                                <div class="p-5">
									...
									<img src="<?php echo base_url('asset/img/logo.png');?>" alt="logo" class="img-logo">
                                        <h1 class="h4 text-gray-900 mb-4">Welcome to Hyhr Ambasssdor Program</h1>
										 <p>Passion, personal experience and first hand knowledge of cannabis products to drive real interactions that create positive experience for new users</p>
                                    </div>
