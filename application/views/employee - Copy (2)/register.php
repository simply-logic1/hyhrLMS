...
.bg-register-image
{
 ...
 .bg-img{
    background: url(<?php echo base_url('asset/img/Hyhr_Ambassador.png');?>);
	background-size:cover;
	background-position:center;
    height: 100% !important;
    max-height: 100% !important;
                   ...
                   <div class="col-lg-6 form_div">
                                <div class="p-5">
									...
									<img src="<?php echo base_url('asset/img/logo.png');?>" alt="logo" class="img-logo">
                                        <h1 class="h4 text-gray-900 mb-4">Welcome to Hyhr Ambasssdor Program</h1>
										 <p class="mb-4">Passion, personal experience and first hand knowledge of cannabis products to drive real interactions that create positive experience for new users</p>
