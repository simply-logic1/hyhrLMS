                   ...
                   <div class="col-lg-5 form_div">
                                <div class="p-5">
									...
									<img src="<?php echo base_url('asset/img/logo.png');?>" alt="logo" class="img-logo">
                                        <h1 class="h4 text-gray-900 mb-4">Welcome to HYHR Admin Panel</h1>
              ...
              ?>
                                    ...
                                    <form action="<?php echo base_url('check_user');?>" method="post">           
										...
										<label for="username">Username</label>
                                            <input type="text" required class="form-control form-control-user" id="user_name" name="user_name" aria-describedby="emailHelp" placeholder="Username">
                                        </div>
                                        <div class="form-group">
