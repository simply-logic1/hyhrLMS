...
<a href="<?php echo base_url('admin/client');?>"  name="back_btn" id="back_btn"  class="ccustom-btn-main nd-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"> &lt; Back</a>
