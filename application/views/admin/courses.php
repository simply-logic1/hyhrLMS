    ...
    <div class="container-fluid">
        ...
        <div class="card card-video shadow mb-4">
           ...
           if(isset($msg))
           {
            ...
            ?>
            <div class="alert alert-success hide-flash"><?php echo $message; ?></div>
...
if(empty($courses))
{
  echo '<div class="row"><div class="col-lg-12 text-center">No Video there</div></div>';
}
