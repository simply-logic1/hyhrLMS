    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
                ...
                <div class="sidebar-brand-text mx-3"> <a href="#" class="site_title"><img src="<?php echo base_url();?>asset/img/logo.png"  class=""></a>
 </div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('admin/document');?>">
                    <i class="fas fa-fw fa-table"></i>
