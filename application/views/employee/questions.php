...
<?php 
 ...
 if(!empty($ques))
 {
			    ...
			    <div class="form-group-inner">
		                  <div class="card-header">
		                      	...
		                      	<input type="hidden" name="question<?php echo $index;?>" id="question" value="<?php echo $question['qid'];?>">
								        <label class="login2 "><?php echo $index."."; echo "<b>".$question['question']."</b></label>"; ?>
	...
	<div class="form-check  question-check">
				...
				<input class="form-check-input answer" type="radio" name="inlineRadioOptions" id="answer_q'.$index.'" name="answer_q'.$index.'" class="answer" value=<?php echo $anss_arr[0];?>"  >
